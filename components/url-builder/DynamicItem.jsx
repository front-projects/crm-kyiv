      ...
      {isEditing ? (
        <div className="flex items-center gap-2">
          <input
            ...
            type="text"
            className="p-2 bg-[#131a22] rounded-md text-white border-2"
            placeholder="Crative Headline*"
          />
          <div
            className="text-green-400 cursor-pointer text-[130%]"
            onClick={submitEdit}
          >
            <FaCheckCircle />
          </div>
          <div
            className="text-red-400 text-[150%] cursor-pointer"
            onClick={cancelEdit}
          >
            <IoMdCloseCircle />
          </div>
        ...
        <>
          <div className="bg-gray-600 p-2 rounded-md flex items-center gap-2">
            <div>{item}</div>
            <div
              className="text-[130%] ml-2 cursor-pointer"
